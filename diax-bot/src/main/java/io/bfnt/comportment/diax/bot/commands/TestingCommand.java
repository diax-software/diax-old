 ...
 */
@io.bfnt.comportment.diax.bot.lib.command.DiaxCommandDescription(triggers = "testing", minimumArgs = 2, ownerOnly = false, donorOnly = false, guildOnly = true, description = "Something about the command", permission = net.dv8tion.jda.core.Permission.ADMINISTRATOR)
